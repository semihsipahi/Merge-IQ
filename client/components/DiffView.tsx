...
const exampleDiff: DiffLine[] = [
  ...
  { type: "context", content: "import { log } from './logger'" },
  { type: "context", content: "" },
  { type: "context", content: "export function sum(a, b) {" },
  { type: "add", content: "  if (typeof a !== 'number' || typeof b !== 'number') return 0;" },
  { type: "context", content: "  log('sum', a, b);" },
  { type: "context", content: "  return a + b;" },
  { type: "remove", content: "  // TODO: handle NaN" },
  { type: "context", content: "}" },
  { type: "context", content: "" },
  { type: "context", content: "export function multiply(a, b) {" },
  { type: "add", content: "  if (a == null || b == null) return 0;" },
  { type: "context", content: "  return a * b;" },
  { type: "context", content: "}" },
  { type: "context", content: "" },
  { type: "context", content: "export function divide(a, b) {" },
  { type: "context", content: "  if (b === 0) return null;" },
  { type: "add", content: "  log('divide', a, b);" },
  { type: "context", content: "  return a / b;" },
  { type: "context", content: "}" },
  { type: "context", content: "" },
  ...
  { type: "add", content: "- Added multiply and divide utils" },
  { type: "add", content: "- Improved Button component" },
  { type: "remove", content: "- Initial version" },
  { type: "context", content: "" },
  { type: "context", content: "// logger.js" },
  { type: "add", content: "export function log(...args) {" },
  { type: "add", content: "  if (process.env.NODE_ENV !== 'production')" },
  { type: "add", content: "    console.log('[LOG]', ...args);" },
  { type: "add", content: "}" },
];
